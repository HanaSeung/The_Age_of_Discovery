...
ASSETS = os.path.join(ROOT, 'assets')  # 그림 원본·육안 확인용 PNG 자리

SRC        = os.path.join(ASSETS, 'frigate_sailing_ships.png')
OUT_JS     = os.path.join(ROOT,   'ship_sprite.js')
OUT_SET    = os.path.join(ASSETS, 'ship_sprite_set.png')
OUT_FURL   = os.path.join(ASSETS, 'ship_sprite_furl.png')
