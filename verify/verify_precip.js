...
// ===== 1. 배선 =====
console.log('\n=== 1. 배선 ===');
chk('data/precip_data.js 를 불러온다', /<script src="data\/precip_data\.js"><\/script>/.test(src));
...
chk('data/airtemp_data.js 를 불러온다', /<script src="data\/airtemp_data\.js"><\/script>/.test(src));
...
vm.runInContext(fs.readFileSync(D + 'data/precip_data.js', 'utf8'), box);
vm.runInContext(fs.readFileSync(D + 'data/airtemp_data.js', 'utf8'), box);
vm.runInContext([
...
chk('data/precip_data.js 를 읽었다', !!vm.runInContext('!!window.PRECIP', box));
chk('data/airtemp_data.js 를 읽었다', !!vm.runInContext('!!window.AIRTEMP', box));
