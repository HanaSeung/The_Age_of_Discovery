...
// 1) script 태그 연결 확인
console.log('script tag linked :', html.includes('src="data/currents_data.js"'));
...
eval(fs.readFileSync(D + 'data/currents_data.js', 'utf8').replace('window.CURRENTS', 'var CURRENTS'));
