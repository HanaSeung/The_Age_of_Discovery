...
//   A. 데이터 — data/ship_sprite.js 가 실은 두 PNG 가 유효하고, 크기·hullLen 이 성하고,
...
const html = fs.readFileSync(RELOC_ROOT+'/world_chart.html', 'utf8');
const sjs  = fs.readFileSync(RELOC_ROOT+'/data/ship_sprite.js', 'utf8');
...
chk('data/ship_sprite.js 를 불러온다', /<script src="data\/ship_sprite\.js">/.test(html));
